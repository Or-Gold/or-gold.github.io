    ...
    initCustomStats() {
        ...
        if (this.statMap.get("tier") === "Crafted") {
            ...
            if (this.statMap.get("category") === "weapon") {
                ...
                this.statMap.set("nDamBaseLow", Math.floor((parseFlot(this.statMap.get("nDamLow")) + parseFlot(this.statMap.get("nDam"))) / 2));
                this.statMap.set("nDamBaseHigh", Math.floor((parseFlot(this.statMap.get("nDamLow")) + parseFlot(this.statMap.get("nDam"))) / 2));
                for (const e in skp_elements) {
                    this.statMap.set(skp_elements[e] + "DamBaseLow", Math.floor((parseFlot(this.statMap.get(skp_elements[e] + "DamLow")) + parseFlot(this.statMap.get(skp_elements[e] + "Dam"))) / 2));
                    this.statMap.set(skp_elements[e] + "DamBaseHigh", Math.floor((parseFlot(this.statMap.get(skp_elements[e] + "DamLow")) + parseFlot(this.statMap.get(skp_elements[e] + "Dam"))) / 2));
                }
